            ...
            <div className="custom-row">
              <div className="form-step-contect">
                <div className="heading-top">
                  <h2 className="h2">{t("buyer.revenue.title")}</h2>
                  <div
                ...
                <form>
                  <div className="form-inner-block">
                    <div className="form-left-content">
                      <h3 className="h3">{t("buyer.revenue.Q1")}</h3>
                      <ul
                        className="property-select"
                        onChange={(e) => handleonChangeTenantsType(e)}
                      >
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              type="radio"
                              name="Any Type For tenants"
                              value="Any Type"
                              checked={
                                getpreferences?.tenantsType === "Any Type"
                              }
                            />
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              type="radio"
                              name="Residential  For tenants"
                              value="Residential"
                              checked={
                                getpreferences?.tenantsType === "Residential"
                              }
                            />
                            <div className="checkbox-lables">
                              {t("Residential")}
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              type="radio"
                              name="Commercial  For tenants"
                              value="Commercial"
                              checked={
                                getpreferences?.tenantsType === "Commercial"
                              }
                            />
                            <div className="checkbox-lables">
                              {t("Commercial")}
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              type="radio"
                              name="Office  For tenants"
                              value="Office"
                              checked={getpreferences?.tenantsType === "Office"}
                            />
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              type="radio"
                              name="Warehouse  For tenants"
                              value="Warehouse"
                              checked={
                                getpreferences?.tenantsType === "Warehouse"
                              }
                            />
                            <div className="checkbox-lables">
                              {t("Warehouse")}
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              type="radio"
                              name="Industrial  For tenants"
                              value="Industrial"
                              checked={
                                getpreferences?.tenantsType === "Industrial"
                              }
                            />
                            <div className="checkbox-lables">
                              {t("Industrial")}
                      ...
                      <h3 className="h3">{t("buyer.revenue.Q2")}</h3>
                      <ul
                        className="property-select"
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              ...
                              value="Any Type"
                              checked={
                                getpreferences?.buildingType === "Any Type"
                              }
                            />
                            <div className="checkbox-lables">
                              {t("any_type")}
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              ...
                              value="single_family"
                              checked={
                                getpreferences?.buildingType === "single_family"
                              }
                            />
                            <div className="checkbox-lables">
                              {t("single_family")}
                      ...
                      <h3 className="h3">{t("buyer.revenue.Q3")}</h3>
                      <ul
                        className="property-select"
                        onChange={(e) => handleonChangeInvestment(e)}
                      >
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              ...
                              value="400k-800k"
                              checked={
                                getpreferences?.investment === "400k-800k"
                              }
                            />
                            <div className="checkbox-lables">
                              {t("400k-800k")}
                        ...
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
                              ...
                              value="800k-1.2mil"
                              checked={
                                getpreferences?.investment === "800k-1.2mil"
                              }
                            />
                            <div className="checkbox-lables">
                              {t("800k-1.2mil")}
                      ...
                      <h3 className="h3">{t("buyer.revenue.Q4")}</h3>
                      <ul
                        className="property-select"
                        onChange={(e) => handleonChangeDownPayment(e)}
                      >
                        <li>
                          <label className="custom-checkbox-btn">
                            <input
